...
export class CheckInputDateFormat {
    ...
    validate(propertyKeyCapitalized, propertyValue, formInputName, formInputValue, propertyErrorText) {
        ...
        let checkAllDateValueArrayFieldsType = function () {
            for (let i = 0; i < propertyDateValueArrayLength; i++) {
                ...
                if(propertyDateValueArray[i] !== true && typeof (propertyDateValueArray[i]) !== "number"){
                    console.log("FormRider.js ERROR", "Property value of dateFormat can only contain values type of number or true");
                    throw new CustomError("FormRider.js ERROR", "Property value of dateFormat can only contain values type of number or true");
                }
            }
        };
        ...
        if(checkCharacterIfNumber(formInputValue[formInputValueLength-1]) === false){
...
//====================================================================================================
                ...
                if (numberOfDateValueFieldsContainingTrue === 1) {
                    ...
                    for (let i = 0; i < propertyDateValueArrayLength; i++) {
                        ...
                        if (typeof (propertyDateValue) === "number") {
                            ...
                            //this might only catch the first character in the input
                ...
                if(numberOfDateValueFieldsContainingTrue > 1){
                    console.log("FormRider.js ERROR", "Property value of dateFormat more that a single true value located at the propertyDateValueArray[1]");
